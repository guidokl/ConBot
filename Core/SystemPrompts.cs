...
namespace ConBot.Core
{
    public static class SystemPrompts
    {
        ...
        {
            string lengthConstraint = verbosity.ToLowerInvariant() switch
            {
                "long" => "a detailed explanation including architectural context, edge cases, and related commands",
                "medium" => "an explanation including flag definitions and a brief example",
                "short" or _ => "a brief, single-sentence explanation (maximum 3 lines)"
            };
